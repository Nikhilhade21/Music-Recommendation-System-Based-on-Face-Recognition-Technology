...
frame_alpr = tk.LabelFrame(root, text=" --Register-- ", width=600, height=800, bd=5, font=('times', 14, ' bold '),fg="black",bg="#a052b1")
frame_alpr.grid(row=0, column=0, sticky='nw')
...
l1 = tk.Label(frame_alpr, text="__Registration Form__", font=("Times new roman", 30, "bold","italic"),bd=5, bg="#a052b1", fg="white")
l1.place(x=120, y=10)
